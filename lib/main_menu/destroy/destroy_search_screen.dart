...
class DestroySearchScreenFragment extends StatefulWidget {
  @override
  _FragmentState createState() => new _FragmentState();
}
class _FragmentState extends State<DestroySearchScreenFragment> {
  TextEditingController controller = new TextEditingController();
  List<ItemsDestroyMain> _searchResult = [];
  List<ItemsDestroyMain> _itemsInit = [
    new ItemsDestroyMain(
        new ItemsApprove(
            "กค 0809.1/2561",
            "09 กันยายน 2561",
            "เวลา 13.00 น.",
  ...
  _navigate(BuildContext context, ItemsDestroyMain itemMain, IsEdit,
