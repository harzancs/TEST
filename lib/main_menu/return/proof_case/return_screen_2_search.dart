...
import 'package:prototype_app_pang/main_menu/return/proof_case/return_screen_2_search_result.dart';
...
class _FragmentState extends State<ReturnMainScreenFragmentSearch2> {
  ...
  final FocusNode myFocusNodeLawsuitNumber_Low = FocusNode();
  final FocusNode myFocusNodeLawsuitNumber_Book = FocusNode();
  ...
  TextEditingController editLawsuitNumber_Low = new TextEditingController();
  TextEditingController editLawsuitNumber_Book = new TextEditingController();
  ...
  //bool IsLawsuitComplete=false;
  //bool IsLawsuitNonComplete=true;
  ...
  Future<bool> onLoadAction(Map map) async {
    await new ReturnFuture().apiRequestReturnListgetByConAdv(map).then((onValue) {
  ...
  onSearchTextSubmitted(Map map, mContext,IsAction) async {
    ...
    if (_searchResult.length == 0) {
      ...
      final result = await Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ReturnMainScreenFragmentSearchResult(
                            ...
                            child: MaterialButton(
                              onPressed: () {
                                Map map = {
                                 ...
                                 // "IS_LAWSUIT_COMPLETE": IsLawsuitComplete?0:1,
      ...
      /*    Container(
          ...
          */
          ...
          Padding(
            padding: paddingInputBox,
            child: TextField(
              focusNode: myFocusNodeLawsuitNumber_Low,
              controller: editLawsuitNumber_Low,
              keyboardType: TextInputType.text,
              textCapitalization: TextCapitalization.words,
              style: textInputStyle,
              decoration: InputDecoration(
          ...
          Container(
            padding: paddingLabel,
            child: Text("เลขที่หนังสือแจ้งคืน", style: textLabelStyle,),
          ),
          Padding(
            padding: paddingInputBox,
            child: TextField(
              focusNode: myFocusNodeLawsuitNumber_Book,
              controller: editLawsuitNumber_Book,
              keyboardType: TextInputType.text,
              textCapitalization: TextCapitalization.words,
              style: textInputStyle,
              decoration: InputDecoration(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Container(
                      padding: paddingLabel,
                      child: Text("วันที่คืน", style: textLabelStyle,),
                    ),
                    Padding(
                      padding: paddingInputBox,
                      child: TextField(
