...
class ReturnAcceptSentenceScreenFragment extends StatefulWidget {
  ItemsListReturnDetail ItemSentence;
  bool IsPreview;
  bool IsUpdate;
...
class _FragmentState extends State<ReturnAcceptSentenceScreenFragment>  with TickerProviderStateMixin {
  //เมื่อบันทึกข้อมูล
  bool _onSaved = false;
  bool _onSave = false;
  //เมื่อแก้ไขข้อมูล
  ...
  //model คำพิพากษาศาล
  ItemsListReturnDetail itemMain;
  //style text
