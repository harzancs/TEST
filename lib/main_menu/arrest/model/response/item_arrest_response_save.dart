class ItemsArrestResponse {
  ...
  factory ItemsArrestResponse.fromJson(Map<String, dynamic> json) {
    return ItemsArrestResponse(
      ...
      ArrestStaff: List<ItemsArrestResponseArrestStaff>.from(json['ArrestStaff'].map((m) => ItemsArrestResponseArrestStaff.fromJson(m))),
      ArrestLocale: List<ItemsArrestResponseArrestLocale>.from(json['ArrestLocale'].map((m) => ItemsArrestResponseArrestLocale.fromJson(m))),
      ArrestLawbreaker: List<ItemsArrestResponseArrestLawbreaker>.from(json['ArrestLawbreaker'].map((m) => ItemsArrestResponseArrestLawbreaker.fromJson(m))),
      ArrestProduct: List<ItemsArrestResponseArrestProduct>.from(json['ArrestProduct'].map((m) => ItemsArrestResponseArrestProduct.fromJson(m))),
    );
  }
}
