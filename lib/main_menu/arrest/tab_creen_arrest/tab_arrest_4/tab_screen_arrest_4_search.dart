...
class _TabScreenArrest4SearchState extends State<TabScreenArrest4Search> {
                      ...
                      child: Container(
                        ...
                        child: Text(
                          (_itemsInit[index].TITLE_SHORT_NAME_TH != null
                              ? _itemsInit[index].TITLE_SHORT_NAME_TH
                              : _itemsInit[index].TITLE_NAME_TH) + '' +
  ...
  _navigatePreview(BuildContext context,Map map) async {
    ...
    if(Success){
      final result = await Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => TabScreenArrest4Suspect2(ItemsSuspect: ItemsPreview,)),
      );
      print(result);
      /*_itemsData=result;
      Navigator.pop(context,_itemsData);*/
