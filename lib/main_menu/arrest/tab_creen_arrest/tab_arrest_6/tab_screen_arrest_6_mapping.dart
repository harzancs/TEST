...
class _TabScreenArrest6EvidenceState extends State<TabScreenArrest6Mapping>  {
  ...
  Widget _buildSearchResults() {
    ...
    buildCollapsed(index) {
      if(xFine>0){
        _itemsInit
            .ArrestIndictmentDetail[index]
            .editFine.text = xFine.toString();
      }
        ...
        child: Column(
          ...
          children: <Widget>[
            Container(
              ...
              child: Text(
                _itemsInit.ArrestIndictmentDetail[index].TITLE_SHORT_NAME_TH
                    .toString() + '' +
                    _itemsInit.ArrestIndictmentDetail[index].FIRST_NAME + " " +
                    _itemsInit.ArrestIndictmentDetail[index].LAST_NAME,
                ...
                children: <Widget>[
                  _itemsInit.ArrestIndictmentProduct.length > 0
                    ...
                    children: <Widget>[
                      Container(
                        padding: paddingLabel,
                        child: Text("ของกลางA", style: textLabelStyle,),
                      ),
                      Container(
                        padding: paddingLabel,
                                ...
                                child: TextField(
                                  onTap: (){
                                    FocusScope.of(context).requestFocus(
                                        new FocusNode());
                                    _itemsInit.ArrestIndictmentDetail[index]
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                Container(
                  padding: paddingLabel,
                  child: Text("ของกลางB", style: textLabelStyle,),
                ),
                ListView.builder(
                  ...
                  itemBuilder: (BuildContext context, int j) {
                    ...
                    TextEditingController editFine = _itemsInit
                        .ArrestIndictmentProduct[j]
                        .Arrest6Controller
                        .editFine;
                    FocusNode focusFine = _itemsInit
                        .ArrestIndictmentProduct[j]
                        .Arrest6Controller
                        .myFocusNodeFine;
        ...
        return Padding(
          ...
          child: Container(
              ...
              child: ExpandableNotifier(
                controller: _itemsInit.ArrestIndictmentDetail[index]
                    .expController,
                child: Stack(
                  children: <Widget>[
                    Expandable(
        ...
        onPressed: () {
          ...
          for (int i = 0; i < _itemsInit.ArrestIndictmentProduct.length; i++) {
            if (_itemsInit.ArrestIndictmentProduct[i].IsCheckOffence) {
              if (_itemsInit.ArrestIndictmentProduct[i].Arrest6Controller
                  .editFine.text.isEmpty) {
                fine_pro = 0;
              } else {
                fine_pro = double.parse(
                    _itemsInit.ArrestIndictmentProduct[i].Arrest6Controller
                        .editFine.text);
              }
          ...
          for (int i = 0; i < _itemsInit.ArrestIndictmentDetail.length; i++) {
            if (_itemsInit.ArrestIndictmentDetail[i].IsCheckOffence) {
              if (_itemsInit.ArrestIndictmentDetail[i].editFine.text.isEmpty) {
                ...
                fine_detail = double.parse(
                    _itemsInit.ArrestIndictmentDetail[i].editFine.text);
              }
