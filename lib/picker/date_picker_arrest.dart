...
class _DynamicDialogState extends State<ArrestDynamicDialog> {
  ...
  void initState() {
    ...
    int k = 0;
    for (int i = (date_now.year + 543) - 1; i < (date_now.year + 543) + 1;
    i++) {
      year_array.add(i);
  ...
  Widget build(BuildContext context) {
    ...
    TextStyle textTitleStyle = TextStyle(fontSize: 18.0,
        fontFamily: FontStyles().FontFamily,
        fontWeight: FontWeight.w500);
    TextStyle textDataStyle = TextStyle(fontSize: 18.0,
        fontFamily: FontStyles().FontFamily,
